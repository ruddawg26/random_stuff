...
function Invoke-RandomizeList{
    #A Fisher-Yates Shuffle of the Array
       ...
       # This was in the code I found, don't rememebr why but if i look at this again maybe I'll remember why this was left uncommented. But brief look makes no sense it was there at bottom of my code
